            ...
            <div class="col-lg-7 pb-5 ">
                ...
                <div class="d-flex align-items-center mb-4 pt-2">
                    <div class="input-group quantity mr-3" style="width: 130px;">
                        ...
                        <input type="text" name="quantity" class="form-control qty-input bg-secondary text-center" value="1">
                        <div class="input-group-btn">
                    ...
                    <button class="btn btn-primary px-3 AddToCartBtn"><i class="fa fa-shopping-cart mr-1"></i> Add To Cart</button>
                </div>
        ...
        <div class="row px-xl-5">
            <div class="col">
                <div class="nav nav-tabs justify-content-center border-secondary mb-4">
                    <a class="nav-item nav-link active" data-toggle="tab" href="#tab-pane-1">Reviews (0)</a>
                </div>
